...
function App() {
  ...
  useEffect(() => {
    ...
    const wsUrl = wsBaseUrl
      ? `${wsBaseUrl}/ws/operations`
      : `${protocol}://${window.location.host}/ws/operations`;
  ...
  function handleLogin(loggedInVehicle) {
    ...
    const withExpiry = { ...loggedInVehicle, _expiry: Date.now() + 24 * 60 * 60 * 1000 };
    localStorage.setItem("driver_vehicle", JSON.stringify(withExpiry));
    setError("");
  }
