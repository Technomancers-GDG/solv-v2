...
@c:/Users/sam/Documents/Projects/sim-pro-max/modern ui/get-shit-done/references/thinking-models-research.md
...
```bash
node "c:/Users/sam/Documents/Projects/sim-pro-max/modern ui/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
